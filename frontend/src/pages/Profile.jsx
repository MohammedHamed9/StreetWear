    ...
    <div className="min-h-[100vh] ">
      <div className="container mx-auto px-8 py-8">
        <div className="flex flex-col md:flex-row gap-4">
            ...
            <p className="text-sm md-text-lg  text-gray-600 mb-4 ">{user?.email}</p>
            <button onClick={()=>handelLogout()}
             className="text-white bg-red-500 hover:bg-red-600 transition px-8 py-4 w-full rounded-lg">Logout</button>
            </div>
